"""Shared world snapshot for RL and the autonomous CNP dispatcher.

This is the single place to extend when the simulated world gains new fields.
Both pipelines read the same numbers: coverage, predicted LLA, battery, eclipse.
"""
...
from harmony.sim.kepler import kepler_from_config
...
def open_world(cfg: dict, prefer_basilisk: bool = True):
    ...
    if prefer_basilisk:
        from harmony.sim.basilisk_world import basilisk_available, basilisk_from_config
